    ...
    <>
      <div className='hero-image'>
        ...
        <div style={{textAlign: "center", marginLeft: "390px"}}>
          <p style={{color: "#000000", width: "60%", fontSize: "20px", paddingTop: "20px"}}> Indulge in a sweet and delightful experience at Candy Land, your ultimate destination for all things candy! Discover a delightful array of popular candies from around the world, each with its own unique flavor and charm.</p>
        </div>
